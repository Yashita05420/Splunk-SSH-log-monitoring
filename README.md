...
3. source="ssh_log_new" host="LinuxServer" soucetype="json"
...
4. source="ssh_log_new" host="LinuxServer" sourcetype="json" |top username
...
5. source="ssh_log_new" host="LinuxServer" sourcetype="json" | iplocation id.orig_h | stats count by Country | where isnotnull(Country)
